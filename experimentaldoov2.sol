...
contract TIKI is ERC20, Ownable {
    ...
    uint256 public immutable fixedSaleEarlyParticipantDuration = 0;
    uint256 public immutable fixedSaleEarlyParticipantBuysThreshold = 0;
    ...
    constructor() public ERC20("TIKItest4", "TIKIv4") {
